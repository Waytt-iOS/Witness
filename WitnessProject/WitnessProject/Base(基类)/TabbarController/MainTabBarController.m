...
//    WaterFallListViewController *homeVC = [WaterFallListViewController new];
    HoomViewController *homeVC = [[HoomViewController alloc]init];
...
//    MakeFriendsViewController *makeFriendVC = [[MakeFriendsViewController alloc]init];
    ThirdViewController *makeFriendVC = [[ThirdViewController alloc]init];
...
//    MsgViewController *msgVC = [[MsgViewController alloc]init];
    FirstViewController *msgVC = [FirstViewController new];
    ...
    SecondViewController *mineVC = [[SecondViewController alloc]init];
